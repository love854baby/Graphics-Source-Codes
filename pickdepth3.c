 ...
 * - multiple squares are hit when we click in their intersection.
 */
 ...
 * In selection mode, each rectangle gets a unique name.
 */
...
void processHits(GLuint hits, GLuint buffer[])
{
   ...
   for (i = 0; i < hits; i++) {  /* for each hit  */      
      ...
      // bug in Red Book, 0x7fffffff is only 2^31-1
